...
public class MediaTypeUtils {
	...
	public static final MediaType APPLICATION_XML =
			new MediaType(	MediaType.APPLICATION_XML.getType(),
	...
	public static final MediaType TEXT_PLAIN = new MediaType(	MediaType.TEXT_PLAIN.getType(),
																MediaType.TEXT_PLAIN.getSubtype(),
																StandardCharsets.UTF_8);
	public static final String TEXT_PLAIN_VALUE = MediaType.TEXT_PLAIN_VALUE + CHARSET;

	public static final MediaType TEXT_HTML = new MediaType(MediaType.TEXT_HTML.getType(),
